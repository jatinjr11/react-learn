      ...
      <div className='parent'>
        {
          jobOpenings.map(function(elem){
            return <Card company={elem.companyName} datePosted={elem.datePosted} location={elem.location} pay={elem.pay} tag1={elem.tag1} tag2={elem.tag2 } post={elem.post} logo={elem.brandLogo} />
          })
        }
      </div>
    </>
